...
NotificationLibrary:SendNotification("Warning", "hãy Follow cho tiktok rubutv", 10)
NotificationLibrary:SendNotification("Warning", "xin chào", 10)
